...
from Joint_resource_allocation import joint_allocation
...
class Hetnet:
    ...
    def reset(self):
        ...
        for i in range(0, len(self.r_U)):
            self.power_levels2[i] = joint_allocation.Algorithm(self.D2D_tr_Power_max, self.N_D2D,
...
def call_model(channel_type, users,  n_cluster, ENERGY, THROUGHPUT):
    ...
    print("\n Joint Resource Allocation Running ...")
